                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                      ...
                      <a className="dropdown-item d-flex align-items-center" href="#">
                        <div className="dropdown-list-image mr-3">
                          <img className="rounded-circle" src="./public/img/undraw_profile_1.svg" alt="..."/>
                      ...
                      <a className="dropdown-item d-flex align-items-center" href="#">
                        <div className="dropdown-list-image mr-3">
                          <img className="rounded-circle" src="./public/img/undraw_profile_2.svg" alt="..."/>
                      ...
                      <a className="dropdown-item d-flex align-items-center" href="#">
                        <div className="dropdown-list-image mr-3">
                          <img className="rounded-circle" src="./public/img/undraw_profile_3.svg" alt="..."/>
                  ...
                  <li className="nav-item dropdown no-arrow">
                      <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        ...
                        <img className="img-profile rounded-circle" src="./public/img/undraw_profile.svg"/>
                      </a>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 mb-4">
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        <div className="text-center">
                          <img className="img-fluid px-3 px-sm-4 mt-3 mb-4 a7" src="./public/img/undraw_posting_photo.svg" alt="..."/>
                        </div>
                        <p>
                    ...
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        <p>
                          SB Admin 2 makes extensive use of Bootstrap 4 utility classNamees in order to reduce
