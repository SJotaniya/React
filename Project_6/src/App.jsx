              ...
              {record &&
                record.map((e, i) => (
                  <tr className="tableRow" key={i}>
                    ...
                    <td className="tableCell"> <button className="editBtn" onClick={() => handleEdit(e.id)}>Edit</button> </td>
                    <td className="tableCell"> <button className="deleteBtn" onClick={() => handleDelete(e.id)}>Delete</button> </td>
                    <td className="tableCell"> <button className="completeBtn" onClick={() => handleComplete(e.id)}>Complete</button> </td>
                  </tr>
                ))
              }
            </tbody>
